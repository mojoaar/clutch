...
export const CURATED_SKILLS: CuratedSkill[] = [
  {
    ...
    name: "Brainstorming",
    description:
      "Explores user intent, requirements and design before implementation. Must be used before any creative work.",
  ...
  },
  {
    ...
    description:
      "Ensures an isolated workspace exists via native tools or git worktree fallback before starting feature work.",
    source: "obra/superpowers",
    branch: "main",
    category: "Workflow",
    author: "Superpowers",
  },
  {
    ...
    description:
      "Use when about to claim work is complete, fixed, or passing. Requires running verification commands before asserting success.",
    source: "obra/superpowers",
    branch: "main",
    category: "Workflow",
    author: "Superpowers",
